...
option = st.selectbox("Select the type of chart to display:", ['Top Nouns', 'Top Verbs', 'Top Adjectives', 'Word Cloud'])
...
if option == 'Top Nouns':
    ...
    chart = alt.Chart(df_adjectives.head(num_records)).mark_bar(color='lightgreen').encode(
